...
public class MultichatGUIClient_T extends JPanel implements ActionListener {
   Frame f;
    ...
    public MultichatGUIClient_T(String name) { 
        ...
        q_list = new JPanel(new GridLayout(100,1));//리스트 크기입니다. 최대 100줄
...
/*        if(data_num < 50)
      ...
      //btn.setContentAreaFilled(false); 
        ...
        btn.addActionListener(new ActionListener(){
           ...
           public void actionPerformed(ActionEvent arg0) {
              ...
              data.q_num = q_n;
              int da_buf = data_num;
              if(data_num == 1){// 질문이 1나 남았을때 클릭시 전체 삭제
                  data_b.q = ":CLEAR_ALL";
                  data_b.q_num = 0;
                  sender.send(data_b); 
                  return;
              ...
              System.out.println("==================");
              System.out.println(data_num + "    삭제 이후 저장된 수 ");
   ...
   Button btn;
    ...
    class MyPanel extends JPanel {
        ...
        public MyPanel(){
           setBackground(new Color(240, 200, 200));//rgb컬러
        }
        
        public void paintComponent(Graphics g){//그림이나 도형을 넣을때 기본적으로 사용되는 페인트컴포넌트
           super.paintComponent(g);
           g.drawImage(img1, 15, 10, 150, 184, this);//(이미지, 위치x, 위치y, 크기x, 크기y, this)
           g.drawImage(img2, 130, 0, 400, 200, this);//(이미지, 위치x, 위치y, 크기x, 크기y, this)
